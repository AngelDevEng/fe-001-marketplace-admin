  ...
  return (
    <div className="glass-card p-6 rounded-3xl bg-white border border-gray-100 shadow-lg">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-sm font-black text-gray-800 uppercase">Ventas de la Semana</h3>
          <p className="text-xs text-gray-400 mt-1">Comparado con semana anterior</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 pt-4 border-t border-gray-100">
        <div className="text-center">
          ...
          <p className="text-lg font-black text-gray-800">S/2,157</p>
        </div>
        <div className="text-center border-l border-gray-100">
          <p className="text-xs text-gray-400 font-bold uppercase">Más Alto</p>
          <p className="text-lg font-black text-emerald-600">S/3,200</p>
        </div>
        <div className="text-center border-l border-gray-100">
          <p className="text-xs text-gray-400 font-bold uppercase">Total</p>
          <p className="text-lg font-black text-gray-800">S/15,100</p>
        </div>
      </div>
    </div>
  );
