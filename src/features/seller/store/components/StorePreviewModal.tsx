...
export default function StorePreviewModal({ isOpen, onClose, layoutId }: StorePreviewModalProps) {
    return (
        ...
        >
            <div className="flex-1 overflow-y-auto bg-gray-50/50 p-4 md:p-12 min-h-[600px]">
                <div className="max-w-6xl mx-auto bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] rounded-[3rem] overflow-hidden min-h-screen border border-gray-100 flex flex-col">
                    {/* Header Mock */}
                    <div className="h-20 bg-white border-b border-gray-50 flex items-center justify-between px-10">
                        <div className="w-32 h-6 bg-gray-100 rounded-full animate-pulse"></div>
                        <div className="flex gap-6">
                            <div className="w-12 h-3 bg-gray-100 rounded-full animate-pulse"></div>
                            <div className="w-12 h-3 bg-gray-100 rounded-full animate-pulse"></div>
                            <div className="w-12 h-3 bg-gray-100 rounded-full animate-pulse"></div>
                        </div>
                    </div>
                    ...
                    <div className="p-12 text-center space-y-12">
                        {/* Banner Mock */}
                        <div className="w-full h-[400px] bg-gradient-to-br from-gray-50 to-gray-100 rounded-[3rem] shadow-inner border border-gray-100 flex flex-col items-center justify-center relative overflow-hidden group">
                            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.03]"></div>
                            <div className="w-24 h-24 bg-white rounded-[2rem] flex items-center justify-center shadow-2xl mb-6 relative z-10">
                                <Icon name="Image" className="w-10 h-10 text-gray-200" />
                            </div>
                            <h4 className="text-xl font-black text-gray-300 uppercase tracking-[0.3em] relative z-10">Hero Vision {layoutId}</h4>
