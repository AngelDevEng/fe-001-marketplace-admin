                    ...
                    conversations.map(conv => (
                        ...
                        >
                            <div className="relative">
                                <Image src={conv.avatar} alt={conv.nombre} width={48} height={48} className="rounded-2xl object-cover border-2 border-white shadow-sm group-hover:scale-105 transition-transform" />
        ...
        <>
            <div className="p-6 bg-white border-b border-gray-50 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <Image src={activeConversation.avatar} alt={activeConversation.nombre} width={48} height={48} className="rounded-2xl object-cover border-2 border-emerald-50 shadow-sm" />
                    <div>
