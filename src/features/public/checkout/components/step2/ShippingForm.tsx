        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm">
            ...
            <div className="p-5">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {/* País */}
                    <Field label="País">
                        <input type="text" value="Perú" readOnly className="w-full px-4 py-3 border-2 border-gray-100 rounded-xl text-sm bg-gray-100 text-gray-500 cursor-not-allowed" />
                    </Field>
                        ...
                        <>
                            ...
                            <div className="md:col-span-2">
                                <Field label="Dirección Completa / Street Address" required>
                                    ...
                                    <p className="mt-1 text-[10px] text-gray-400 italic pl-1">¿No conoces la dirección? Usa el mapa para ubicarnos.</p>
                                </Field>
                            </div>
                        </>
                    ) : (
                ...
                <div className="mt-5 p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                    <label className="flex items-center gap-3 cursor-pointer group select-none">
                        <div className="relative inline-flex items-center">
                            ...
                            <div className="w-10 h-6 bg-gray-200 rounded-full peer peer-checked:bg-emerald-500 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full transition-all" />
                        </div>
                        <span className="text-xs font-bold text-emerald-800/70 group-hover:text-emerald-600 transition-colors">
