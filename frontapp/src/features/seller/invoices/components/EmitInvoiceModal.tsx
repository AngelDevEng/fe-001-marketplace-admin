            ...
            return (
                <div className="p-8 flex flex-col items-center gap-6 text-center">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 font-medium mt-2 max-w-xs mx-auto">
            ...
            return (
                <div className="p-8 flex flex-col items-center gap-6 text-center">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-rose-500 font-bold mt-2 bg-rose-50 px-4 py-2 rounded-2xl border border-rose-100 max-w-xs mx-auto">
                            {errorMsg}
                        </p>
                    </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {TYPE_OPTIONS.map(opt => (
                            ...
                            >
                                ...
                                <span className="text-xs font-medium text-gray-400 leading-tight">{opt.desc}</span>
                            </button>
                        ))}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            value={form.series}
                            onChange={set('series')}
                            className="w-full px-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-emerald-500/20 transition-all font-bold text-gray-700"
                        />
                    </div>
                    <div>
                        <label className="text-xs font-black text-gray-400 uppercase tracking-widest mb-2 block">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={set('amount')}
                        placeholder="0.00"
                        className="w-full px-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-emerald-500/20 transition-all font-bold text-gray-700 text-lg"
                    />
                </div>
