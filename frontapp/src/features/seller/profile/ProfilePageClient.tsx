                ...
                <div className="md:col-span-8 overflow-hidden rounded-[2.5rem] shadow-2xl bg-white border border-gray-100">
                    ...
                    <div className="p-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">RUC <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Representante Legal <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">DNI Representante <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Años de Experiencia</label>
                                <input type="number" name="experience_years" readOnly={!isEditMode} value={data.experience_years} onChange={handleInputChange}
                                    className={`${fieldCls} ${isEditMode ? EDIT_FIELD_CLASSES : READONLY_FIELD_CLASSES}`} />
                            </div>
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Departamento / Provincia</label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Condición Tributaria</label>
                        ...
                        <div className="pt-6 mt-8 border-t border-gray-100">
                            <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1 mb-4 block">Presencia en Redes</label>
                            {!isEditMode && (
                            ...
                            {isEditMode && (
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                                    <div className="space-y-1">
                                        <label className="text-xs font-black text-pink-500 uppercase tracking-widest ml-1">Instagram</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-xs font-black text-sky-500 uppercase tracking-widest ml-1">Facebook</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-xs font-black text-gray-500 uppercase tracking-widest ml-1">TikTok</label>
                    ...
                    <div className="overflow-hidden rounded-[2.5rem] shadow-2xl bg-white border border-gray-100 h-full">
                        ...
                        <div className="bg-gradient-to-r from-sky-500 via-sky-500 to-sky-400 p-4 flex items-center justify-between relative overflow-hidden">
                            ...
                            <div className="relative group z-10" onClick={handlePhotoClick}>
                                <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-white/30 shadow-xl backdrop-blur-md group-hover:scale-110 transition-all duration-500 cursor-pointer">
                                    {data.rep_legal_photo ? (
                                        <Image src={data.rep_legal_photo} fill sizes="64px" alt="Representante Legal" className="object-cover" />
                                    ) : (
                        ...
                        <div className="p-8">
                            <div className="space-y-8">
                                <div className="space-y-1">
                                    <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Nombres y Apellidos <span className="text-red-500">*</span></label>
                                    <input type="text" name="admin_nombre" required readOnly={!isEditMode} value={data.admin_nombre} onChange={handleInputChange}
                                        className={`${fieldCls} ${isEditMode ? EDIT_FIELD_CLASSES : READONLY_FIELD_CLASSES}`} />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">DNI Administrador</label>
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Email de Gestión <span className="text-red-500">*</span></label>
                                    <input type="email" name="admin_email" required readOnly={!isEditMode} value={data.admin_email} onChange={handleInputChange}
                                        className={`${fieldCls} ${isEditMode ? EDIT_FIELD_CLASSES : READONLY_FIELD_CLASSES}`} />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Teléfonos de contacto</label>
                    ...
                    <div className="p-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
                            <div className="space-y-1 lg:col-span-3">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Dirección Fiscal <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Cuenta BCP (Soles) <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">CCI <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Entidad Bancaria Interbancaria</label>
