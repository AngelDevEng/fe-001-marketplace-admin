      ...
      <div className="glass-card p-6 rounded-3xl bg-white border border-gray-100 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {kpis.productosTop.map((product, idx) => {
            const productKey = (product as { id?: number; nombre?: string }).id ?? product.nombre ?? `product-${idx}`;
            return (
            <div key={productKey} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
