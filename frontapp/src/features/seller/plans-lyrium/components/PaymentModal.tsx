...
import { formatPrice, getPlanIconSvg } from '@/features/seller/plans-lyrium/lib/helpers';
import { durationPresets, getDiscountForMonths } from '@/features/seller/plans-lyrium/lib/plans';
  ...
  return (
    <Modal open={open} onClose={onClose} className="payment-modal">
      <div className="modal-header-section">
        <div className="modal-plan-icon" style={{ background: data.cssColor }} dangerouslySetInnerHTML={{ __html: iconHtml }} />
