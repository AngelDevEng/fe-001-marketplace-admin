            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-3 space-y-3">
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">Visual Principal</p>
                        <div
                            className="bg-gray-50 border-2 border-dashed border-gray-200 aspect-square flex flex-col items-center justify-center cursor-pointer group rounded-[2rem] overflow-hidden hover:border-sky-300 transition-all shadow-inner"
                            onClick={() => fileInputRef.current?.click()}
                        >
                            {previewImage ? (
                                <Image src={previewImage} fill sizes="100vw" className="object-contain p-2" alt="Product" />
                            ) : (
                                <div className="text-center group-hover:scale-110 transition-transform">
                                    <Icon name="Image" className="text-4xl text-gray-300 w-10 h-10 mx-auto" />
                                    <p className="text-[9px] font-black text-gray-400 uppercase mt-2">Adjuntar Foto</p>
                                </div>
                            )}
                            <input
                                type="file"
                    ...
                    <div className="lg:col-span-9 space-y-3">
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">Metadatos del Producto</p>
                            ...
                            <table className="w-full text-sm">
                                <tbody className="divide-y divide-gray-50/50">
                                    <tr className="bg-gray-50/10">
                                        <td className="px-5 py-3 font-black text-gray-400 text-[10px] uppercase tracking-tighter w-1/4">Denominación</td>
                                        <td className="px-5 py-3">
                                            <input
                                                type="text" name="name" required
                                                value={formData.name} onChange={handleChange}
                                                className="w-full bg-transparent border-none focus:ring-0 font-black text-gray-800 p-0 outline-none text-base"
                                                placeholder="Nombre comercial"
                                            />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="px-5 py-3 font-black text-gray-400 text-[10px] uppercase tracking-tighter">Categoría</td>
                                        <td className="px-5 py-3">
                                            <select
                                                name="category" required
                                                value={formData.category} onChange={handleChange}
                                                className="w-full bg-transparent border-none focus:ring-0 font-bold text-gray-700 p-0 outline-none cursor-pointer"
                                            >
                                    ...
                                    <tr className="bg-gray-50/10">
                                        <td className="px-5 py-3 font-black text-gray-400 text-[10px] uppercase tracking-tighter">Valorización</td>
                                        <td className="px-5 py-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-transparent border-none focus:ring-0 font-black text-gray-800 p-0 outline-none"
                                                    placeholder="0.00"
                                                />
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td className="px-5 py-3 font-black text-gray-400 text-[10px] uppercase tracking-tighter">Operativo</td>
                                        <td className="px-5 py-3">
                                            <div className="grid grid-cols-3 gap-6 divide-x divide-gray-100">
                                                <div className="flex flex-col gap-1">
                                                    <span className="text-[8px] font-black text-gray-300 uppercase">Stock</span>
                                                    <input
                                                ...
                                                <div className="flex flex-col gap-1 pl-4">
                                                    <span className="text-[8px] font-black text-gray-300 uppercase">Peso (kg)</span>
                                                    <input
                                                ...
                                                <div className="flex flex-col gap-1 pl-4">
                                                    <span className="text-[8px] font-black text-gray-300 uppercase">Dimen (LxWxH)</span>
                                                    <input
                                                        type="text" name="dimensions"
                                                        value={formData.dimensions || ''} onChange={handleChange}
                                                        className="w-full bg-transparent border-none focus:ring-0 font-black text-gray-800 p-0 outline-none font-mono text-[10px]"
                                    ...
                                    <tr className="bg-gray-50/10">
                                        <td className="px-5 py-2 font-black text-gray-400 text-[10px] uppercase tracking-tighter">Promoción</td>
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-2">Reseña del Producto</label>
                        <textarea
                            name="description" rows={2} required
                            value={formData.description} onChange={handleChange}
                            className="w-full bg-gray-50 border border-gray-100 rounded-[1.5rem] p-4 text-sm font-medium text-gray-600 outline-none focus:ring-4 focus:ring-sky-500/5 focus:bg-white transition-all resize-none"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between px-2">
                                ...
                                <div className="flex gap-2">
                                    <button type="button" onClick={() => addAttribute('main')} className="w-7 h-7 bg-white border border-gray-100 rounded-lg flex items-center justify-center text-sky-500 hover:bg-sky-50 transition-all shadow-xs active:scale-90">
                                        <Icon name="Plus" className="font-bold text-xs w-3 h-3" />
                                    </button>
                                    <button type="button" onClick={() => addAttributeColumn('main')} className="px-2 h-7 bg-white border border-gray-100 rounded-lg flex items-center gap-1 text-[8px] font-black text-emerald-500 hover:bg-emerald-50 transition-all shadow-xs uppercase active:scale-90">
                                        <Icon name="Columns" className="font-bold w-3 h-3" />
                                    </button>
                                </div>
                            </div>
                            <div className="rounded-[1.5rem] overflow-hidden border border-gray-100 bg-white shadow-xs">
                                <table className="w-full text-xs">
                                    <tbody className="divide-y divide-gray-50">
                                        {(formData.mainAttributes || []).map((attr, rowIndex) => (
                                            <tr key={rowIndex} className="divide-x divide-gray-50 group border-b last:border-none">
                                                {attr.values.map((val, colIndex) => (
                                                    <td key={colIndex} className="px-3 py-2">
                                                        <input
                                                            ...
                                                            className={`w-full bg-transparent border-none focus:ring-0 text-[11px] outline-none ${colIndex === 0 ? 'font-black text-gray-800 uppercase tracking-tighter' : 'font-medium text-gray-500'}`}
                                                            placeholder={colIndex === 0 ? 'Ej: Material' : 'Valor'}
                                                        />
                                                    </td>
                                                ))}
                                                <td className="px-2 py-2 text-center w-8">
                                                    <button type="button" onClick={() => removeAttribute('main', rowIndex)} className="text-gray-300 hover:text-rose-500 transition-colors opacity-0 group-hover:opacity-100">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between px-2">
                                ...
                                <button type="button" onClick={() => addAttribute('additional')} className="w-7 h-7 bg-white border border-gray-100 rounded-lg flex items-center justify-center text-indigo-500 hover:bg-indigo-50 transition-all shadow-xs active:scale-90">
                                    <Icon name="Plus" className="font-bold text-xs w-3 h-3" />
                                </button>
                            </div>
                            <div className="rounded-[1.5rem] overflow-hidden border border-gray-100 bg-white shadow-xs">
                                <table className="w-full text-xs text-gray-400 font-mono">
                                    <tbody className="divide-y divide-gray-50">
                                                ...
                                                {attr.values.map((val, colIndex) => (
                                                    <td key={colIndex} className="px-3 py-2">
                                                        <input
                                                            ...
                                                            className="w-full bg-transparent border-none focus:ring-0 text-[10px] font-bold text-gray-600 outline-none"
                                                            placeholder="..."
                                                        />
                                                    </td>
                                                ))}
                                                <td className="px-2 py-2 text-center w-8">
                                                    <button type="button" onClick={() => removeAttribute('additional', rowIndex)} className="text-gray-300 hover:text-rose-500 transition-colors opacity-0 group-hover:opacity-100">
                                                        <Icon name="Trash2" className="font-bold w-4 h-4" />
                                                    </button>
                                                </td>
                                            </tr>
                                        ...
                                        {(!formData.additionalAttributes || formData.additionalAttributes.length === 0) && (
                                            <tr>
                                                <td className="p-4 text-center text-[9px] font-black text-gray-300 uppercase italic">Sin adicionales</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
                ...
                <div className="flex justify-end gap-3 pt-6 border-t border-gray-50 sticky bottom-0 bg-white/90 backdrop-blur-md -mx-8 -mb-8 p-6">
                    <BaseButton
                        variant="ghost"
                        onClick={onClose}
                    >
