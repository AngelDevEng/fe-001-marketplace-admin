import { AnalyticsData } from '@/lib/types/admin/analytics';

export const MOCK_ANALYTICS_DATA: AnalyticsData = {
    resumenGlobal: {
        clv_promedio: 1450.50, // Customer Lifetime Value (Valor de vida)
        tasa_retencion: 42.5,  // Porcentaje de compras repetidas
        conversion_media: 3.8, // Conversion de visitas a compras
        frecuencia_compra: 3.2 // Veces que un cliente compra en el periodo
    },
    vendedoresAnalitica: [
    ...
    comportamientoClientes: {
        ...
        frecuencia_segmentos: {
            VIP: 8,         // Compran cada 8 días
            Recurrente: 25, // Compran cada 25 días
            Ocasional: 60   // Compran cada 60 días
        }
    }
};
