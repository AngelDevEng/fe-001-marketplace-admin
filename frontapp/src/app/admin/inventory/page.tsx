...
import { Search, Package, Activity, AlertCircle, ShoppingBag, X, Check, Eye, Download, RefreshCw } from 'lucide-react';
...
export default function InventoryPage() {
    ...
    return (
        <div className="space-y-8 animate-fadeIn font-industrial pb-20">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-end">
                    <div className="lg:col-span-1 space-y-2 w-full">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Radar de Filtros</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Vendedor / Nodo</label>
                        <select
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Estado Operativo</label>
                        <select
            ...
            {selectedItem && (
                <ModalsPortal>
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                        <div className="absolute inset-0 bg-gray-900/60 backdrop-blur-md animate-fadeIn" onClick={() => setSelectedItem(null)} />
                        <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-2xl relative overflow-hidden p-12 animate-scaleUp font-industrial">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Stock Operativo</label>
                                        <input
                                            type="number"
                                            defaultValue={selectedItem.stock}
                                            id="edit-stock"
                                            className="w-full p-5 bg-gray-50 border-none rounded-2xl text-xl font-black text-indigo-600 focus:ring-2 focus:ring-indigo-500/10"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Valor Unitario (S/)</label>
                                        <input
                                            type="number"
                                            step="0.01"
                                            defaultValue={selectedItem.price}
                                            id="edit-price"
                                            className="w-full p-5 bg-gray-50 border-none rounded-2xl text-xl font-black text-gray-900 focus:ring-2 focus:ring-indigo-500/10"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 pt-4">
                                    ...
                                    <BaseButton
                                        ...
                                        variant="ghost"
                                        className="w-16 h-16 rounded-2xl bg-gray-50 p-0"
                                    >
                                        <X className="w-5 h-5" />
                                    </BaseButton>
                                </div>
            ...
            {/* AUDIT MODAL TELEPORTED */}
            {historyItem && (
                <ModalsPortal>
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                        <div className="absolute inset-0 bg-gray-900/60 backdrop-blur-sm animate-fadeIn" onClick={() => setHistoryItem(null)} />
                        <div className="bg-white w-full max-w-xl rounded-[3rem] shadow-2xl relative overflow-hidden p-12 animate-scaleUp font-industrial">
                            ...
                            <div className="space-y-4 max-h-[40vh] overflow-y-auto pr-4 custom-scrollbar">
                                {[1, 2, 3, 4].map(i => (
                                    <div key={i} className="flex items-center gap-6 p-6 border-l-4 border-emerald-400 bg-gray-50/50 rounded-r-[2rem]">
                                        <div className="w-12 h-12 bg-white rounded-2xl shadow-sm flex items-center justify-center shrink-0">
                                            {i === 1 ? <Activity className="w-6 h-6 text-emerald-600" /> : <Eye className="w-6 h-6 text-blue-600" />}
                                        </div>
                                        <div className="flex-1">
                                            <div className="flex justify-between items-start">
                                                <p className="text-[11px] font-black text-gray-900 uppercase">Ajuste de Existencias</p>
                            ...
                            <BaseButton
                                ...
                                variant="primary"
                                className="w-full mt-10 h-16 rounded-2xl bg-gray-900 hover:bg-black"
                            >
                                Cerrar Bitácora
                            </BaseButton>
                        </div>
