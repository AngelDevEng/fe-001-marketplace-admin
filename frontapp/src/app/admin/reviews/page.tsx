                    ...
                    <div className="space-y-4">
                        <div className="p-6 bg-rose-50 border border-rose-100 rounded-3xl">
                            ...
                            <div className="flex gap-2">
                                <button className="flex-1 py-2 bg-white text-rose-600 border border-rose-200 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-rose-100">Eliminar</button>
                                <button className="flex-1 py-2 bg-gray-900 text-white rounded-xl text-[9px] font-black uppercase tracking-widest">Ignorar</button>
                            </div>
                        </div>
                    </div>
                </div>
