...
// --- Modal Wrapper (Architectural Pattern: Externalized to avoid redeclaration on render) ---
    ...
    <ModalsPortal>
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
            <div
                ...
                onClick={onClose}
            ></div>
            <div className="relative z-10 bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-scaleUp p-10 font-industrial">
                ...
                <div className="text-center mb-8">
                    ...
                    <h3 className="text-2xl font-black text-gray-800 tracking-tight uppercase">{title}</h3>
            ...
            {activeModal === 'escalate' && (
                ...
                >
                    <form className="space-y-6" onSubmit={(e) => {
                        ...
                        <div>
                            <label className="text-[10px] font-black text-gray-400 uppercase ml-1 block mb-2">Destino de Escalamiento</label>
                            <select name="destino" required className="w-full p-4 bg-gray-50 border-none rounded-2xl font-black text-gray-700">
                        ...
                        <div>
                            <label className="text-[10px] font-black text-gray-400 uppercase ml-1 block mb-2">Motivo / Justificación</label>
                        ...
                        <div className="flex gap-4">
                            <button type="submit" className="flex-1 py-4 bg-amber-500 text-white rounded-2xl font-black hover:bg-amber-600 transition-all shadow-xl shadow-amber-100/50 uppercase tracking-widest text-xs">Confirmar Escalamiento</button>
                        </div>
                    </form>
                </ModalWrapper>
            )}
            ...
            {activeModal === 'survey' && (
                ...
                >
                    <form className="space-y-8" onSubmit={(e) => {
                        ...
                        <p className="text-sm font-black text-gray-700 text-center uppercase tracking-tight">¿Se resolvió tu problema de manera efectiva?</p>
                        ...
                        <div>
                            <label className="text-[10px] font-black text-gray-400 uppercase ml-1 block mb-2">Comentarios (Opcional)</label>
                        ...
                        <button type="submit" className="w-full py-5 bg-gray-900 text-white rounded-[1.5rem] font-black hover:bg-black transition-all shadow-xl uppercase tracking-widest text-xs">Enviar y Cerrar Ticket</button>
                    </form>
                </ModalWrapper>
            )}
            ...
            {activeModal === 'faq-detail' && faqSelected && (
                ...
                >
                    <div className="space-y-6">
                        <p className="text-sm text-gray-600 font-medium leading-relaxed">{faqSelected.contenido}</p>
                        <div className="pt-8 border-t border-gray-100 flex items-center justify-between">
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">¿Fue útil este artículo?</p>
                            <div className="flex gap-4">
                                <button className="px-6 py-3 bg-emerald-50 text-emerald-600 rounded-xl font-black text-[10px] flex items-center gap-2 hover:bg-emerald-100 transition-all uppercase">
                                    <ThumbsUp className="w-4 h-4" /> SI ({faqSelected.util_si})
                                </button>
                                <button className="px-6 py-3 bg-red-50 text-red-600 rounded-xl font-black text-[10px] flex items-center gap-2 hover:bg-red-100 transition-all uppercase">
