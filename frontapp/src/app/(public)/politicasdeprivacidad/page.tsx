...
import { privacyData } from '@/features/public/politicasdeprivacidad/data/privacyData';
                                ...
                                {section.list && (
                                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {section.list.map((item) => (
                                            <li key={item} className="flex items-center gap-3 text-white p-4-gray-600 bg rounded-xl border border-gray-50 shadow-sm">
