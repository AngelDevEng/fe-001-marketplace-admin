...
export default function PolaroidCard({ image, rotation, onDelete }: PolaroidCardProps) {
    return (
        <div className={`relative group w-28 scale-95 hover:scale-100 hover:z-10 transition-all duration-300 ${rotation}`}>
            <div className="bg-white p-2 pb-6 shadow-xl border border-gray-100 rounded-sm">
                <div className="aspect-square overflow-hidden bg-gray-50 border border-gray-50">
            ...
            <div className="absolute top-1 left-1/2 -translate-x-1/2 w-8 h-3 bg-white/40 backdrop-blur-sm -rotate-2 border border-white/20"></div>
        </div>
    );
}
