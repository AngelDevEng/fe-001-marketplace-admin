            ...
            <div className="p-10 grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div className="lg:col-span-4 xl:col-span-3 space-y-8">
                    <div className="flex flex-col items-start">
                        ...
                        >
                            <img src={config.visual.logo} alt="Logo" className="w-28 h-28 object-contain group-hover:scale-110 transition-transform duration-700" />
                ...
                <div className="lg:col-span-8 xl:col-span-9 space-y-10">
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            >
                                <img src={config.visual.banner1} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
                            ...
                            >
                                {config.visual.banner2 ? (
                                    <>
                                        <img src={config.visual.banner2} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
                                        <div className="absolute top-4 left-4">
