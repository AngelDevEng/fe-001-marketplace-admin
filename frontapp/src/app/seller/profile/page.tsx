...
export default function ProfilePage() {
    ...
    if (loading) {
        return <BaseLoading message="Sincronizando con tu tienda en WordPress..." fullPage />;
    }
    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <form className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="flex items-center gap-5 text-white relative z-10">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <p className="text-[10px] font-bold text-sky-100 uppercase tracking-[0.2em] opacity-80">Gestión de Entidad Legal</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="space-y-1">
                                ...
                                <input type="text" name="razon_social" required readOnly={!isEditMode} value={data.razon_social} onChange={handleInputChange}
                                    className={`w-full text-sm font-black text-gray-800 bg-transparent p-3 border-2 border-gray-100 rounded-xl outline-none focus:border-sky-500 transition-all ${isEditMode ? EDIT_FIELD_CLASSES : READONLY_FIELD_CLASSES}`} />
                            </div>
                            <div className="space-y-1">
                            ...
                            <div className="space-y-1">
                                ...
                                <select name="tax_condition" disabled={!isEditMode} value={data.tax_condition} onChange={handleInputChange}
                                    className={`w-full text-sm font-black text-gray-800 bg-transparent p-3 border-2 border-gray-100 rounded-xl outline-none focus:border-sky-500 transition-all cursor-pointer ${isEditMode ? EDIT_FIELD_CLASSES : READONLY_FIELD_CLASSES}`}>
                        ...
                        <div className="bg-gradient-to-r from-sky-500 via-sky-500 to-sky-400 p-8 flex items-center justify-between relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-5 text-white relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-sky-100 uppercase tracking-[0.2em] mt-1 opacity-80">Contacto Directo</p>
                                </div>
                            </div>
                    ...
                    <div className="bg-gradient-to-r from-sky-500 via-sky-500 to-sky-400 p-8 flex items-center justify-between relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-5 text-white relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-sky-100 uppercase tracking-[0.2em] mt-1 opacity-80">Configuración de Facturación y Cuentas</p>
                            </div>
                        </div>
                    </div>
