...
import { usePlanes } from '@/features/seller/plans-lyrium/hooks/usePlanes';
import { useSSE } from '@/features/seller/plans-lyrium/hooks/useSSE';
import { motivationalMessages, notificationMessages } from '@/features/seller/plans-lyrium/lib/plans';

import AccessBlocked from '@/features/seller/plans-lyrium/shared/AccessBlocked';
import Notification from '@/features/seller/plans-lyrium/shared/Notification';
import Modal from '@/features/seller/plans-lyrium/shared/Modal';
import Timeline from '@/features/seller/plans-lyrium/components/Timeline';
import CurrentPlanCard from '@/features/seller/plans-lyrium/components/CurrentPlanCard';
import Showcase from '@/features/seller/plans-lyrium/components/Showcase';
import Carousel from '@/features/seller/plans-lyrium/components/Carousel';
import PaymentModal from '@/features/seller/plans-lyrium/components/PaymentModal';
import { BenefitAskModal, BenefitFullModal } from '@/features/seller/plans-lyrium/components/BenefitModals';
import { DowngradeModal, DowngradeConfirm2Modal } from '@/features/seller/plans-lyrium/components/DowngradeModals';
import ExpiracionBanner from '@/features/seller/plans-lyrium/components/ExpiracionBanner';
import IzipayForm from '@/features/seller/plans-lyrium/components/IzipayForm';
    ...
    <>
      ...
      <Modal open={state.modals.requestSent} onClose={planes.closeRequestSentModal} className="request-sent-modal" showClose={false}>
        <div style={{ textAlign:'center', padding:'8px' }}>
          ...
          <div dangerouslySetInnerHTML={{ __html: state.sentText }} style={{ marginTop:'12px', lineHeight:1.6 }} />
