            ...
            <div className="space-y-8 animate-fadeIn text-left font-industrial">
                ...
                <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden p-8">
                    <div className="space-y-6">
                        {[1, 2, 3, 4, 5].map(idx => (
                            <div key={idx} className="flex gap-6 py-4 border-b border-gray-50 last:border-0 items-center">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
                <div className="flex flex-col md:flex-row gap-6 items-end">
                    <div className="flex-1 space-y-2 w-full">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Radar de Contratos</label>
