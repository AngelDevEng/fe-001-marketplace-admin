                ...
                {kpis.map((kpi: TreasuryKPI) => (
                    <div key={kpi.label} className={`bg-white p-6 border-l-4 border-${kpi.color}-500 transition-all hover:scale-[1.02] rounded-2xl shadow-sm`}>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-2xl font-black text-gray-800 tracking-tighter">{kpi.val}</span>
                        </div>
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mt-2">{kpi.label}</p>
                    </div>
                ))}
            </div>

            {/* Navigation Tabs (Finanzas + Pagos Combined) */}
            <div className="flex flex-wrap gap-2 pt-6 border-t border-gray-100 overflow-x-auto custom-scrollbar">
                {[
                    ...
                    <div className="flex-1 space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-none rounded-xl text-xs focus:ring-2 focus:ring-indigo-500/20 font-industrial font-bold"
                            />
                        </div>
                    </div>
