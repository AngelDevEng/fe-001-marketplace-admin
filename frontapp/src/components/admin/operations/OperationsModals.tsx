        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-8 font-industrial">
            <div className="col-span-2 space-y-2">
                ...
                <input
                    ...
                    className="w-full p-4 bg-gray-50 border-none rounded-2xl text-sm font-black text-gray-800 focus:ring-4 focus:ring-blue-500/10"
                />
            </div>
                    ...
                    {getDynamicFields(formData.tipo || 'Economista').map((field) => (
                        <div key={field.key} className="space-y-1">
                            ...
                            <input
                                ...
                                className="w-full p-2 bg-white rounded-xl text-[11px] font-bold border-none"
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    className="w-full p-4 bg-gray-50 border-none rounded-2xl text-xs font-bold"
                />
            </div>
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 font-industrial">
            <input
                ...
                placeholder="------"
                maxLength={6}
                className="w-full text-4xl font-black text-center tracking-[1rem] py-6 bg-gray-50 border-none rounded-3xl focus:ring-4 focus:ring-blue-500/10 placeholder:text-gray-200 font-industrial"
            />
