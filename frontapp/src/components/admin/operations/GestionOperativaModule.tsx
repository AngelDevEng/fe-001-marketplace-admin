        ...
        return (
            <div className="space-y-6 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div key="gestion-op-kpi-1" className="bg-white p-8 rounded-[2rem] shadow-sm space-y-4">
                    ...
                    <div key="gestion-op-kpi-2" className="bg-white p-8 rounded-[2rem] shadow-sm space-y-4">
                        <div className="flex justify-between items-center">
                            <Skeleton className="h-14 w-14 rounded-2xl" />
                            <Skeleton className="h-10 w-16 rounded-md" />
                        </div>
                    ...
                    <div key="gestion-op-kpi-3" className="bg-white p-8 rounded-[2rem] shadow-sm space-y-4">
                        <div className="flex justify-between items-center">
                            <Skeleton className="h-14 w-14 rounded-2xl" />
                            <Skeleton className="h-10 w-16 rounded-md" />
                        </div>
                    ...
                    <div key="gestion-op-kpi-4" className="bg-white p-8 rounded-[2rem] shadow-sm space-y-4">
                        <div className="flex justify-between items-center">
                            <Skeleton className="h-14 w-14 rounded-2xl" />
                            <Skeleton className="h-10 w-16 rounded-md" />
                        </div>
                ...
                <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
                    ...
                    <div key="gestion-op-row-1" className="flex gap-4 py-4 border-b border-gray-50 last:border-0">
                    ...
                    <div key="gestion-op-row-2" className="flex gap-4 py-4 border-b border-gray-50 last:border-0">
                        <Skeleton className="h-12 w-12 rounded-full" />
                        <div className="flex-1 space-y-2">
                            <Skeleton className="h-4 w-1/4 rounded" />
                            <Skeleton className="h-3 w-1/3 rounded" />
                    ...
                    <div key="gestion-op-row-3" className="flex gap-4 py-4 border-b border-gray-50 last:border-0">
                        <Skeleton className="h-12 w-12 rounded-full" />
                        <div className="flex-1 space-y-2">
                            <Skeleton className="h-4 w-1/4 rounded" />
                            <Skeleton className="h-3 w-1/3 rounded" />
                    ...
                    <div key="gestion-op-row-4" className="flex gap-4 py-4 border-b border-gray-50 last:border-0">
                        <Skeleton className="h-12 w-12 rounded-full" />
                        <div className="flex-1 space-y-2">
                            <Skeleton className="h-4 w-1/4 rounded" />
                            <Skeleton className="h-3 w-1/3 rounded" />
                    ...
                    <div key="gestion-op-row-5" className="flex gap-4 py-4 border-b border-gray-50 last:border-0">
                        <Skeleton className="h-12 w-12 rounded-full" />
                        <div className="flex-1 space-y-2">
                            <Skeleton className="h-4 w-1/4 rounded" />
                            <Skeleton className="h-3 w-1/3 rounded" />
        ...
        <div className="space-y-6 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {kpis.map((kpi: OperationalKPI) => (
                    <div key={kpi.label} className={`bg-white p-8 border-l-4 border-${kpi.color}-500 transition-all hover:scale-[1.02] rounded-[2rem] shadow-sm`}>
