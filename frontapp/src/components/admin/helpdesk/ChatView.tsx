        ...
        <div className="flex-1 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full">
                ...
                <div className="flex-shrink-0 p-3 bg-white border-t border-gray-50 space-y-2">
                    ...
                    <form onSubmit={handleSubmit} className="relative">
                        ...
                        <button
                            type="submit"
                            className="absolute right-3 bottom-3 px-4 py-2 bg-gray-900 text-white rounded-lg font-black text-[10px] uppercase tracking-widest hover:bg-black transition-all flex items-center gap-1"
                        >
