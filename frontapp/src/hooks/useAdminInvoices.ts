 ...
 * useAdminInvoices.ts
 * ---------------------------------------------------------------
 * Hook para la vista de administración de comprobantes Rapifac.
 * Consume GET /api/rapifac/invoices (sin filtro → todas las facturas).
 * ---------------------------------------------------------------
 */

import { useState, useEffect, useCallback } from 'react';
import { StoredInvoice } from '@/lib/rapifac/invoiceStore';
